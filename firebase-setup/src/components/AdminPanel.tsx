...
export default function AdminPanel({
  ...
  const handleSaveToServer = async () => {
    setIsSaving(true);
    setSaveStatus({ text: 'Syncing all changes to Firebase cloud in real-time...', isError: false });
    try {
      const payload = {
        categories,
        services,
      ...
      console.error(error);
      setSaveStatus({ text: 'Failed to sync to Firebase. Please check your connection.', isError: true });
    } finally {
      setIsSaving(false);
    }
  };
